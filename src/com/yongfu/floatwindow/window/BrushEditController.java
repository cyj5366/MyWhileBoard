...
public class BrushEditController extends BaseController
{
  ...
  public BrushEditController(GlobalWindowManager paramGlobalWindowManager, int paramInt1, int paramInt2, NavWindowController paramNavWindowController)
  {
    ...
    createBrushEditPanel();
  }

  private void createBrushEditPanel()
  {
    this.editBrushLayout = new FrameLayout(this.base.context);
    this.editBrushLayout.setBackgroundColor(0);
    this.base.layoutInflater.inflate(R.layout.brush_settings, this.editBrushLayout);
    ...
    this.base.windowManager.addView(this.editBrushLayout, this.layoutParams);
  }
  ...
  public void checkBrushEditPosition(int paramInt1, int paramInt2)
  {
    if (this.isShowing)
    {
      ...
      this.base.showView(this.editBrushLayout, this.layoutParams, this.width, this.height, paramInt1, i);
    }
  }
  ...
  {
    return this.editBrushLayout;
  }

  protected void hide()
  {
    super.hide();
    this.base.hideView(this.editBrushLayout, this.layoutParams);
  }
  ...
  protected void show()
  {
    ...
    this.base.showView(this.editBrushLayout, this.layoutParams, this.width, this.height, 0, -this.base.fullScreenY / 2);    
  }
