...
public class SaveViewController extends BaseController
{
  private boolean closedByBrushEditor = false;
  public FrameLayout saveviewLayout;
  ...
  public SaveViewController(GlobalWindowManager paramGlobalWindowManager, int paramInt1, int paramInt2, NavWindowController paramNavWindowController)
  {
  ...
  {
    this.saveviewLayout = new FrameLayout(this.base.context);
    this.saveviewLayout.setBackgroundColor(0);
    this.base.layoutInflater.inflate(R.layout.save_pice, this.saveviewLayout);
    ...
    this.base.windowManager.addView(this.saveviewLayout, this.layoutParams);
  }
  ...
  public void checkBrushEditPosition(int paramInt1, int paramInt2)
  {
    if (this.isShowing)
    {
      ...
      this.base.showView(this.saveviewLayout, this.layoutParams, this.width, this.height, paramInt1, i);
    }
  }
  ...
  {
    return this.saveviewLayout;
  }

  protected void hide()
  {
    super.hide();
    this.base.hideView(this.saveviewLayout, this.layoutParams);
  }
  ...
  protected void show()
  {
    ...
    this.base.showView(this.saveviewLayout, this.layoutParams, this.width, this.height, 0, -this.base.fullScreenY / 2);
  }
